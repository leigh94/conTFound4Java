...
- 行为型
   ...
   - [访问者模式](visitorPattern/README.md)
...
- 单一职责原则[Single Responsibility Principle，SRP]
  ...
  - 解析：一个类只负责一项职责，如果一类承担的责任过多，就等于把这些职责耦合在一起，一个职责的变化可能回削弱或者抑制这个类完成其他职责的能力
  - 例子：
  ```java
  // 假设我们有一个类，它负责处理员工信息和计算工资。根据SRP，我们应该将这两个职责分离。
  // 违反SRP的例子
  class Employee {
    // 计算工资
